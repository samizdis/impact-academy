...
def reflection( things_to_reflect_on, work_dir = ".", research_problem = "", **kwargs):
    ...
    """
    reflection = complete_text_openai(prompt, log_file=kwargs["log_file"])
...
def understand_file( file_name, things_to_look_for, work_dir = ".", **kwargs):
    ...
    """
        ...
        completion = complete_text_openai(prompt, log_file=kwargs["log_file"]+f"_{idx}")
...
def edit_script(script_name, edit_instruction, save_name, work_dir = ".", **kwargs):
    ...
    completion = complete_text_openai(prompt, log_file=kwargs["log_file"], model=EDIT_SCRIPT_MODEL, max_tokens_to_sample=EDIT_SCRIPT_MAX_TOKENS)
...
"""
    ...
    retrieval = complete_text_openai(prompt, log_file=kwargs["log_file"])
